...
Item {
    id: homeScreen
    // ODPOWIADA ZA HEAT SELECT DIALOG
    property var heatSelectDialogHolder: null

    function createHeatSelectDialog() {
        if ( heatSelectDialogHolder === null ) {
            var component = Qt.createComponent( "HeatSelectDialog.qml" )    // otworzenie nowego okna QML
    ...
    Text {
        ...
        color: "white"
        font.pixelSize: 200
        text: systemController.currentSystemTemperature // odpowiada za zawartość tekstu
    }
    ...
    Text {
        ...
        font.pixelSize: 30
        color: "white"
        text: systemController.systemStatusMessage  // odpowiada za zawartość tekstu
    }
    ...
    Image {
        ...
        width: 70
        height: 70
        // ZMIANA OBRAZKA W ZALEŻNOŚCI OD STANU
        source: {
        ...
        MouseArea {
            anchors.fill: parent
            onClicked: createHeatSelectDialog() // utworzy okno popUp które zasłoni środek okna
        }
    }
