    ...
    QMainWindow (0,Qt::Window)
{
    ...
    connect (penMenuAA,SIGNAL (toggled(bool)),paint,SLOT (setPolyAA(bool)));
    connect (textMenuAA,SIGNAL (toggled(bool)),paint,SLOT (setTextAA(bool)));
