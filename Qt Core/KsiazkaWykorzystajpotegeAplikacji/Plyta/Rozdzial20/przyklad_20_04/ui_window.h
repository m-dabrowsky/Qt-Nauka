...
**
** Created: Fri 25. Jan 13:23:11 2008
...
public:
    ...
    toolBarFile->addAction(fileMenuPrint);
    toolBarFile->addAction(fileMenuSavePDF);
    ...
    fileMenuPrint->setStatusTip(QApplication::translate("Window", "Drukuj plik", 0, QApplication::UnicodeUTF8));
    fileMenuSavePDF->setText(QApplication::translate("Window", "Zapisz PDF", 0, QApplication::UnicodeUTF8));
    fileMenuSavePDF->setStatusTip(QApplication::translate("Window", "Zapisz plik PDF", 0, QApplication::UnicodeUTF8));
