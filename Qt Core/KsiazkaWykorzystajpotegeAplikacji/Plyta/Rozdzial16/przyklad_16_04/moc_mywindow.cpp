...
static const char qt_meta_stringdata_MyWindow[] = {
    "MyWindow\0\0GetExistingDirectory()\0"
    "GetOpenFileName()\0GetOpenFileNames()\0"
    "GetSaveFileName()\0"
};
...
int MyWindow::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: GetExistingDirectory(); break;
        case 1: GetOpenFileName(); break;
        case 2: GetOpenFileNames(); break;
        case 3: GetSaveFileName(); break;
        }
        _id -= 4;
    }
    return _id;
